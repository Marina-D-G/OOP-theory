...
SelfCounting::SelfCounting() : SelfCounting(42)  //initialization of constants can only be done while creating them so the only possible way is in the initialization list
{}
