...
NVector operator*(size_t scalar, const NVector& lhs); //commutative

bool operator||(const NVector& lhs, const NVector& rhs); //are parallel

size_t operator%(const NVector& lhs, const NVector& rhs); //scalar product

bool operator|=(const NVector& lhs, const NVector& rhs); //are perpendicular
